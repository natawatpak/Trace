...
extern int                  _frame_vextract(__frame_frameobject*, enum AVPixelFormat, enum AVCodecID, char*, va_list v) attribute_hidden;

int _frame_vextract(__frame_frameobject* self, enum AVPixelFormat pixfmt, enum AVCodecID codecID, char* format, va_list ap) {
...
weak_alias(_frame_vextract, vframe_extract);
