...
extern int                  _frame_optextract(__frame_frameobject*, enum AVPixelFormat, enum AVCodecID, char*, struct __frame_extract_opt) attribute_hidden;


int _frame_optextract(__frame_frameobject* self, enum AVPixelFormat pixfmt, enum AVCodecID codecID, char* format, struct __frame_extract_opt extopt) {
...
weak_alias(_frame_optextract, frame_optextract);
